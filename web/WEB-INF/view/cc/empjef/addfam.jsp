...
<form class="layui-form" action="">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="contactName" lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">与员工关系：</label>
        <div class="layui-input-inline">
            <input type="text" name="relationship" lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
...
<script>
    layui.use(['form', 'layer'], function(){
        ...
        form.on('submit(sub)', function(data){
            ...
            //部门数据
            $.ajax({
                url: "${pageContext.request.contextPath}/CJEF/addfam",
                type: "post",
                async:true,
                dataType: "json",
                data:{
