...
<form id="erlmForm" class="layui-form layui-form-pane" action="" lay-filter="example">
    ...
    layui.use(['form', 'layer','laydate'], function(){
        ...
        form.on('submit(sub)', function(data){
            ...
            $.ajax({
                ...
                url: "${pageContext.request.contextPath}/erlment/updlist" ,//url
                data:{
                    enrollmentId:${enrollment.enrollmentId},
                    studName:fd.studName,
                    card:fd.card,
                    sex:fd.sex,
                    tell:fd.tell,
                    school:fd.school,
                    classes:fd.classes,
                    score:fd.score,
                    studType:fd.studType,
                    majorId:fd.majorId,
                    negativeName:fd.negativeName,
                    computer:fd.computer,
                    remark:fd.remark
                },
        ...
        //表单赋值
        form.val('example', {
            "studName":"${enrollment.studName}"
            ,"card": "${enrollment.card}"
            ,"sex": "${enrollment.sex}"
            ,"tell": "${enrollment.tell}"
            ,"school": "${enrollment.school}"
            ,"classes": "${enrollment.classes}"
            ,"score": "${enrollment.score}"
            ,"studType": "${enrollment.studType}"
            ,"majorId": "${enrollment.majorId}"
            ,"negativeName": "${enrollment.negativeName}"
            ,"computer": "${enrollment.computer}"
