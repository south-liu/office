...
<form class="layui-form" action="">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width: 100px;">
            <input type="text" name="holidayDay" id="holidayDay" placeholder="请选择天数" lay-verify="required|number" autocomplete="off" class="layui-input" value="0">
        </div>
        <div class="layui-form-mid">天</div>
        <div class="layui-input-inline" style="width: 150px;">
            <select name="holidayHour" id="holidayHour" lay-filter="noCardTime">
                <option value="">请选择小时数</option>
